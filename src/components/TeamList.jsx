...
[
  ...
  },
  {
    ...
    code: '9',
    info: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium hic quaerat dignissimos aliquid consectetur unde, quibusdam quasi.',
    networks: 
    [
      { id: uuidv4(), name: <FaTwitter className='ourTeamIconInfo' /> },
      { id: uuidv4(), name: <FaFacebookF className='ourTeamIconInfo' /> },
  ...
  },
  {
    ...
    code: '13',
    info: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugiat earum exercitationem in possimus voluptatibus eaque ducimus asperiores, deleniti delectus.',
    networks: 
    [
      { id: uuidv4(), name: <FaTwitter className='ourTeamIconInfo' /> },
      { id: uuidv4(), name: <FaFacebookF className='ourTeamIconInfo' /> },
  ...
  },
  {
    ...
    name: "Bruce Wayne",
    title: 'XXXXXX XXXXXX',
    image: 'https://i.pravatar.cc/450?img=52',
    code: '52',
    info: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Atque expedita eveniet omnis a saepe unde architecto, nisi aliquam?',
    networks: 
    [
